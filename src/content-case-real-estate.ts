/**
 * ADJL Technologies — /work/real-estate-intelligence/ — the property underwriting scanner.
 *
...
export const content: CaseContent = {
  ...
  limits: {
    ...
    body: "A scanner described only by what it gets right is not being described. These are the failure modes. You will meet them, and it is better to meet them here.",
    items: [
      "Data coverage varies by county. Some assessors publish machine-readable records going back decades; others publish scanned images, or publish late, or publish nothing. Output quality tracks that, and the file says which county you are in.",
      "Thin markets produce thin comparables. In a submarket with few recent transactions the rent and value bands widen to the point of being uninformative, and the system reports a wide band rather than narrowing it to look decisive.",
      "A model inherits the assumptions you give it. Exit cap, rent growth, vacancy, reserves and financing terms are inputs, not findings. Feed it optimistic assumptions and it will produce an optimistic underwriting, neatly formatted and fully sourced.",
      "A machine cannot see a building. Deferred maintenance, a bad roof, a difficult neighbour, a tenant about to leave, the smell in the basement: none of it appears in a record or a listing photo. This narrows what you have to inspect. It does not replace the inspection."
    ]
  },
  meta: {
    title: "Property underwriting scanner — ADJL Technologies",
    ...
    ogTitle: "Property underwriting scanner — ADJL Technologies",
